...
public class PaloAltoResourceTest {
	...
	public void implementGuestNetwork() throws ConfigurationException, ExecutionException {
		...
		IpAddressTO ip = new IpAddressTO(Long.valueOf("1"), "192.168.80.102", true, false, true, "untagged", null, null,
				null, 100, false);
	...
	public void shutdownGuestNetwork() throws ConfigurationException, ExecutionException {
		...
		IpAddressTO ip = new IpAddressTO(Long.valueOf("1"), "192.168.80.102", false, false, true, "untagged", null,
				null, null, 100, false);
		IpAddressTO[] ips = new IpAddressTO[1];
		ips[0] = ip;
		IpAssocCommand cmd = new IpAssocCommand(ips);
	...
	public void addIngressFirewallRule() throws ConfigurationException, Exception {
		...
		FirewallRuleTO active = new FirewallRuleTO(8, null, "192.168.80.103", "tcp", 80, 80, false, false,
	...
	public void removeIngressFirewallRule() throws ConfigurationException, Exception {
		...
		long vlanId = 3954;
		List<FirewallRuleTO> rules = new ArrayList<FirewallRuleTO>();
		FirewallRuleTO revoked = new FirewallRuleTO(8, null, "192.168.80.103", "tcp", 80, 80, true, false,
	...
	public void addEgressFirewallRule() throws ConfigurationException, Exception {
		...
		List<String> cidrList = new ArrayList<String>();
		cidrList.add("0.0.0.0/0");
		FirewallRuleVO activeVO = new FirewallRuleVO(null, null, 80, 80, "tcp", 1, 1, 1, Purpose.Firewall, cidrList,
				null, null, null, FirewallRule.TrafficType.Egress);
		FirewallRuleTO active = new FirewallRuleTO(activeVO, Long.toString(vlanId), null, Purpose.Firewall,
	...
	public void removeEgressFirewallRule() throws ConfigurationException, Exception {
		...
		long vlanId = 3954;
		List<FirewallRuleTO> rules = new ArrayList<FirewallRuleTO>();
		FirewallRuleVO revokedVO = new FirewallRuleVO(null, null, 80, 80, "tcp", 1, 1, 1, Purpose.Firewall, null, null,
				null, null, FirewallRule.TrafficType.Egress);
		revokedVO.setState(State.Revoke);
		FirewallRuleTO revoked = new FirewallRuleTO(revokedVO, Long.toString(vlanId), null, Purpose.Firewall,
				FirewallRule.TrafficType.Egress);
		rules.add(revoked);
	...
	public void addStaticNatRule() throws ConfigurationException, Exception {
		...
		StaticNatRuleTO active = new StaticNatRuleTO(0, "192.168.80.103", null, null, "10.3.97.158", null, null, null,
				false, false);
		rules.add(active);
	...
	public void removeStaticNatRule() throws ConfigurationException, Exception {
		...
		long vlanId = 3954;
		List<StaticNatRuleTO> rules = new ArrayList<StaticNatRuleTO>();
		StaticNatRuleTO revoked = new StaticNatRuleTO(0, "192.168.80.103", null, null, "10.3.97.158", null, null, null,
				true, false);
		rules.add(revoked);
	...
	public void addPortForwardingRule() throws ConfigurationException, Exception {
		...
		PortForwardingRuleTO active = new PortForwardingRuleTO(9, "192.168.80.103", 80, 80, "10.3.97.158", 8080, 8080,
				"tcp", false, false);
		rules.add(active);
	...
	public void removePortForwardingRule() throws ConfigurationException, Exception {
		...
		long vlanId = 3954;
		List<PortForwardingRuleTO> rules = new ArrayList<PortForwardingRuleTO>();
		PortForwardingRuleTO revoked = new PortForwardingRuleTO(9, "192.168.80.103", 80, 80, "10.3.97.158", 8080, 8080,
				"tcp", true, false);
		rules.add(revoked);
